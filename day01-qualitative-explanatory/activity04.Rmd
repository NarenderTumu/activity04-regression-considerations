...
11) R appears to handle categorical variables with more than 2 levels by removing one level from the total numer of levels. Here since there are 3 levels, R is using only 2 of them by removing teaching.
